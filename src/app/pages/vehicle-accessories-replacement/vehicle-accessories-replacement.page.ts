...
@Component({
  ...
  templateUrl: './vehicle-accessories-replacement.page.html',
  styleUrls: ['./vehicle-accessories-replacement.page.scss'],
})
export class VehicleAccessoriesPage implements OnInit {
  ...
  update() {
    ...
    this.router.navigateByUrl(`/pre-inspection-replacement/${this.mva}`);
